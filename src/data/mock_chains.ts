...
export const MOCK_CHAINS: IChain[] = [
    {
        ...
        description: 'Bitcoin 是世界上第一個去中心化的加密貨幣，由中本聰於 2008 年提出。它使用點對點網絡和工作量證明共識機制來處理交易和保護網絡安全。Bitcoin 被廣泛視為「數位黃金」，是目前市值最高的加密貨幣。',
        stats: [
    ...
    },
    {
        ...
        color: 'text-white',
        bgColor: 'bg-white/10',
        description: 'Ethereum 是一個開源的去中心化區塊鏈網絡，是構建去中心化應用程序 (DApps) 的首選平台。它引入了智能合約功能，允許開發者編寫自動執行的代碼。Ethereum 的原生加密貨幣是 Ether (ETH)，用於支付交易手續費和計算服務。隨著 Ethereum 2.0 的升級，網絡正從工作量證明 (PoW) 過度到權益證明 (PoS)，以提高擴展性、安全性和可持續性。',
        stats: [
    ...
    },
    {
        ...
        color: 'text-white',
        bgColor: 'bg-white/10',
        description: 'X Layer 是一個基於 ZK 技術的以太坊 Layer 2 網絡，旨在連接 OKX 生態系統和以太坊社區。它提供低成本、高效率的交易體驗，並與以太坊虛擬機 (EVM) 完全兼容。',
        stats: [
    ...
    },
    {
        ...
        description: 'Solana 是一個高性能的區塊鏈，旨在提供快速、安全和可擴展的去中心化應用程序和市場。它利用獨特的歷史證明 (PoH) 共識機制來提高吞吐量。',
        stats: [
    ...
    },
    {
        ...
        description: 'TRON 是一個致力於構建去中心化互聯網基礎設施的區塊鏈平台。它通過高吞吐量和可擴展性支持大規模的去中心化應用程序。',
        stats: [
    ...
    },
    {
        ...
        description: 'BNB Chain 是一個由 Binance 支持的區塊鏈網絡，由 BNB Beacon Chain 和 BNB Smart Chain (BSC) 組成。它支持智能合約並與以太坊虛擬機 (EVM) 兼容。',
        stats: [
    ...
    },
    {
        ...
        description: 'Base 是一個由 Coinbase 孵化的以太坊 Layer 2 網絡，旨在為下一個十億用戶提供安全、低成本的區塊鏈體驗。',
        stats: [
    ...
    },
    {
        ...
        description: 'Sui 是一個無需許可的 Layer 1 區塊鏈，從零開始設計，旨在讓創作者和開發者構建滿足下一個十億用戶需求的體驗。',
        stats: [
