        ...
        <div className="mb-8">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                    <button className="flex h-8 w-8 items-center justify-center rounded border border-gray-200 text-gray-500 hover:border-gray-400 hover:text-black">
                        <FileText size={16} />
                    </button>
                    <button className="flex h-8 w-8 items-center justify-center rounded border border-gray-200 text-gray-500 hover:border-gray-400 hover:text-black">
                        <Twitter size={16} />
                ...
                <div className="flex items-center gap-2 text-xs text-gray-500">
                    <span>全部數據</span>
                    <div className="relative h-4 w-8 rounded-full bg-gray-300">
                        <div className="absolute left-0.5 top-0.5 h-3 w-3 rounded-full bg-white shadow"></div>
                    </div>
                </div>
            </div>
        </div>
