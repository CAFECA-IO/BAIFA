    ...
    <div className="flex w-full flex-col space-y-4">
      ...
      <div className="flex w-full flex-col bg-darkPurple p-4">
        ...
        <div className="flex w-full flex-col items-end space-y-4">
          ...
          <SearchBar searchBarPlaceholder={`Search in Transaction History`} setSearch={setSearch} />
        </div>
        {/* Info: (20231103 - Julian) Address List */}
        <div className="my-10 flex w-full flex-col space-y-2 lg:space-y-0">{transactionList}</div>
