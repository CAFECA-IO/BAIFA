...
export default function Footer() {
  return (
    <footer className="w-full bg-black px-6 py-16 pb-32 text-white">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-20 flex flex-col items-center justify-center text-center">
          ...
          <div className="relative w-full max-w-md">
            ...
            />
            <button className="absolute top-1 right-1 h-10 rounded-full bg-[#5841D8] px-6 text-sm font-bold text-white transition hover:bg-[#4b36c0]">
              訂閱
            </button>
          </div>
        </div>
        ...
        <div className="mb-20 grid grid-cols-1 gap-12 lg:grid-cols-9">
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-4 lg:col-span-8">
            ...
            <div className="pt-[44px]">
              {' '}
              {/* Spacer to align with first column list */}
              <ul className="space-y-3 text-xs text-gray-500">
                {browsers2.map((item) => (
                  <li key={item}>
                    <Link href="/" className="transition hover:text-white">
