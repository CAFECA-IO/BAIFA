...
import { Copy, ArrowRight, ChevronLeft, ChevronRight, Loader2, Search } from 'lucide-react';
...
export default function TransactionListPage() {
  ...
  const txnTotalCount = '2,531,269'; // Mocked
              ...
              <tbody className="divide-y divide-gray-50">
                {transactions.map((txn) => (
                  <tr key={txn.hash} className="hover:bg-gray-50/50">
                    ...
                    <td className="px-6 py-5">
                      <div className="flex items-center gap-1.5">
                        <Link href={`/address/${txn.toLabel}`} className="font-mono text-[#5841D8]">
                          {txn.to}
                        </Link>
                        <Copy
                          size={12}
